Now we present the operational semantics of the side condition language. It is shown in Figure \ref{fig:operational}.
The operational semantics is under the judgment of
...
- Match constructs evaluate the scrutinee $S$ and match the result with one of the patterns.
...
\end{equation*}
\begin{equation*}
\inference[ZTOQ-O ]{\judge{1}{S}{z}{2} & r = z/1 }
