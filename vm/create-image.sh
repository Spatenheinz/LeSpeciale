...
# With some additions by Ken Friis Larsen.
...
echo "thesis" | sudo tee $DIR/etc/hostname
...
sudo chroot $DIR /bin/bash -c "/usr/sbin/useradd -d /home/normie -m -s /bin/bash -G sudo normie"
sudo chroot $DIR /bin/bash -c "passwd normie -d"

sudo mkdir -p $DIR/home/normie/.ssh/
cat $RELEASE.id_rsa.pub | sudo tee $DIR/home/normie/.ssh/authorized_keys
## End Ken addition
...
# Mads additions
# Install some useful packages such as stuff needed to build ebpf-test
sudo chroot $DIR /bin/bash -c "apt-get install -y libffi-dev binutils binutils-dev build-essential git lsb-release"
# Copy the stack-installation script
# sudo cp installhaskell.sh $DIR/home/normie/installhaskell.sh
# sudo chroot $DIR /bin/bash -c "chown normie /home/normie/installhaskell.sh; sudo chmod +x /home/normie/installhaskell.sh"

# sudo chroot --userspec=normie:normie $DIR /bin/bash -c "su - normie -c ./installhaskell.sh"
# sudo chroot --userspec=normie:normie $DIR /bin/bash -c "su - normie; cd /home/normie; curl --proto '=https' --tlsv1.2 -sSf https://get-ghcup.haskell.org | \
#          BOOTSTRAP_HASKELL_NONINTERACTIVE=1 \
#          BOOTSTRAP_HASKELL_MINIMAL=1 \
#          BOOTSTRAP_HASKELL_ADJUST_BASHRC=1 \
#          sh; \
# source /home/normie/.ghcup/env; \
# ghcup upgrade; \
# ghcup install cabal; \
# ghcup install stack; \
