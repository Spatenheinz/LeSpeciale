...
cmake -DCMAKE_INSTALL_PREFIX="$BASE_DIR" -DCMAKE_BUILD_TYPE=Release .. #-DCMAKE_BUILD_TYPE="Debug" ..
make install #CXX_FLAGS=-DDEBUG_SYM_NAMES CXX_FLAGS=-DDEBUG_APPS #CXX_FLAGS=-DDEBUG_REFCNT #CXX_FLAGS=-DDEBUG_HOLE_NAMES
popd
